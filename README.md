...
- Timestamp: `2022-07-05 14:19`
- Build ID: `1eb5b9fc-4a24-47b3-977d-e3e50acc3631`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1eb5b9fc-4a24-47b3-977d-e3e50acc3631.git
$ cd 1eb5b9fc-4a24-47b3-977d-e3e50acc3631
```
